...
export default function EntrySessionsTable({
  sessions,
  onViewSession,
  currentPage = 1,
  totalPages = 1,
    ...
    <div className="entry-sessions-table-wrapper">
      ...
      <div className="table-footer">
        <p className="results-text">
          Showing <span className="results-count">{sessions.length}</span> of <span className="results-count">{totalItems}</span> results
        </p>
